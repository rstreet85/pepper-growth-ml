...
**Data Preparation:** The process of converting the raw data to training/testing/validation data is detailed in the Jupyter notebooks located in the **notebooks/** directory. Each step is numbered:

1. [Data-ETL](notebooks/1 - Data-ETL.ipynb) - The first stage of data processing. Pull the days to maturity and growing degree days (F).
